 ...
 * Contract YAML for a message exchange (input and output).
 *
 * @author Dave Syer
 */
public class MessageContractYmlSnippet implements Snippet {
	 ...
	 */
	protected MessageContractYmlSnippet() {
		this(null);
	}
	 ...
	 */
	protected MessageContractYmlSnippet(Map<String, Object> attributes) {
		this(SNIPPET_NAME, TEMPLATE_NAME, attributes);
	}

	protected MessageContractYmlSnippet(String snippetName, String templateName,
